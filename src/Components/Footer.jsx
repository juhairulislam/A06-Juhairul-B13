...
{/* footer 1 */}
            <div className='space-y-4'>
                <h1 className='text-3xl text-center lg:text-left font-bold'>DigiTools</h1>
                <p className='text-[12px] text-center lg:text-left text-[#ffffffa0]'>Premium digital tools for creators, professionals, and businesses. Work smarter with our suite of powerful tools.</p>
            </div>
